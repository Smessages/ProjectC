...
![Alt text](/ProjectC/screenshots/set-aroon-nfs-default.PNG?raw=true "edit to default storageClass")
![Alt text](/ProjectC/screenshots/edit-scLass.png?raw=true "edit to default storageClass")
